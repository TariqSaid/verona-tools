...
window.VT_PRODUCTS = (window.VT_PRODUCTS || []).concat([
...

  {
    id          : 1776031547516,
    category    : 'Outillage',
    subcategory : 'Perceuses et marteaux-piqueurs',
    brand       : 'Bosch',
    title       : 'Bosch Professional GBH 220 Marteau-piqueur rotatif',
    description_fr: 'Marteau-piqueur professionnel Bosch GBH 220 équipé d\'un mandrin SDS pour le forage et le cintre dans le béton, la maçonnerie et la pierre. Puissance de 550W avec mode percussion réglable et poignée auxiliaire ergonomique pour un contrôle optimal et une sécurité accrue lors des travaux en hauteur ou en surface difficile.',
    price_MAD   : 1850,
    in_stock    : true,
    ref         : 'VT-AUTO-7516',
    images      : [
      '/images/products/bosch-professional-gbh-220-rotary-hammer-drill-1-543425.png',
  ...
  },
  {
    ...
    brand       : 'Bosch',
    title       : 'Meuleuse d\'angle Bosch GWS 7-125',
    description_fr: 'Meuleuse d\'angle filaire compacte de 125 mm de diamètre, conçue pour les travaux de meulage, tronçonnage et polissage. Dispose d\'une puissance de 720 W, d\'une vitesse de rotation de 12,000 tr/min et d\'une poignée latérale ergonomique pour un contrôle optimal. Parfaite pour les travaux de construction, de rénovation et les usages professionnels.',
    price_MAD   : 850,
    in_stock    : true,
    ref         : 'VT-AUTO-8964',
    images      : [
      '/images/products/bosch-gws-7-125-angle-grinder-1-625193.png',
